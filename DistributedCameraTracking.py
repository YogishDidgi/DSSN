...
def main(cam1_path, cam2_path):
	...
	while True:
		...
		cam1_personsTracked, num_new_c1, cam1_personRemovedIndexList, cam1_tracker = cam_personTracking(cam1_image, cam1_tracker, personDetectionFlag)
		cam2_personsTracked, num_new_c2, cam2_personRemovedIndexList, cam2_tracker = cam_personTracking(cam2_image, cam2_tracker, personDetectionFlag)
...
def centralServer(cam1_persons, cam2_persons, cam1_image, cam2_image, num_new_c1, num_new_c2, cam1_personRemovedIndexList, cam2_personRemovedIndexList):
	...
	threshold = 2500 #threshold for HFV feature match strength
